...
def main():
    """Read data file and display data of Wimbledon champions and their countries."""
    records = extract_records(FILENAME)
    champion_to_count, countries = process_records(records)
    present_results(champion_to_count, countries)
...
def present_results(champion_to_count, countries):
